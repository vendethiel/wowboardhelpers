...
var templates = {};
templates.author = templates['forum-topics/author'] = (function() {
  var _ref;
  ...
  return function(context) {
    return (function() {
      ...
      $c = c$;
      $o = [];
      $o.push("<span class='" + ($c(["poster", this.own ? "own-poster" : void 0, this.own ? "type-blizzard" : void 0])) + "'>");
      $o.push("" + $c(this.name));
      if (this.cm) {
...
templates.defaultPagination = templates['forum-topics/default-pagination'] = (function() {
  var _ref;
...
templates.hideTopic = templates['forum-topics/hide-topic'] = (function() {
  var _ref;
...
templates.memebox = templates['reply/memebox'] = (function() {
  var _ref;
